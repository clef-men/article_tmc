...
%
\cref{subsec:implementation} explains that implementing the transformation requires a bit of care as a naive implementation is quadratic in function size. We use an applicative functor to structure a single-pass implementation that remains nicely compact and readable.
%
