    ...
    \begin{mathparpagebreakable}
        ...
        \inferrule*[lab=SimSrcConstr1]
            {
                ...
                \iSim[\Chi]{\Phi}{\lambdConstr{c}{e_{s1}}{e_{s2}}}{e_t}
            }
        \and
        ...
        \inferrule*[lab=SimTgtConstr]
            ...
            \and
                ...
                \iSim[\Chi]{\Phi}{e_s}{\lambdConstr{c}{e_{t1}}{e_{t2}}}
            }
        \\
        \inferrule*[lab=SimSrcConstrDet]
            {
                \forall \loc_s \ldotp
                \loc_s \mapsto_s (c, v_{s1}, v_{s2}) \iSepImp
                \iSim[\Chi]{\Phi}{\loc_s}{e_t}
            }{
                \iSim[\Chi]{\Phi}{\lambdConstrDet{c}{v_{s1}}{v_{s2}}}{e_t}
            }
        \and
        \inferrule*[lab=SimTgtConstrDet]
            {
                \forall \loc_t \ldotp
                \loc_t \mapsto_t (c, v_{t1}, v_{t2}) \iSepImp
                \iSim[\Chi]{\Phi}{e_s}{\loc_t}
            }{
                \iSim[\Chi]{\Phi}{e_s}{\lambdConstrDet{c}{v_{t1}}{v_{t2}}}
            }
        \\
