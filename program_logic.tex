...
\Xgabriel{There are two judgments lying around, one with a precondition and one without. I would expect here some explanation about how those two judgments relate.}
