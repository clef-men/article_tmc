\section{A relational separation logic for \DataLang programs}
...
Once we have a deterministic constructor $\datalangBlockDet{c}{\datalangVal_1}{\datalangVal_2}$, the source and target reasoning rules \RefTirName{SimSrcConstrDet} and \RefTirName{SimTgtConstrDet} are symmetric.
%
