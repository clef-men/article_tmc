...
\item Section 3.2 on examples of TRMC functions in OCaml (1.5 pages).
\item \Xgabriel{TODO complete}
\end{itemize}
We thus estimate the reused content at about 3.5 pages \Xgabriel{TODO
  update}, the rest of the content was written from scratch for the
present submission.
...
ours.\Xgabriel{TODO LaTeX references}.
...
easier to evaluate for quality and novelty, and tend to gather more
scientific credit. The implementation work also typically comes
before, and it is easy to do the verification work separately, with
...
contributions together in a republication.
