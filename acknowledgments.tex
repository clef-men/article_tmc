\begin{acks}
  ...
  (\Appendices{\cref{subsec:optin}}{See Appendix~A.2.1}). This experiment also generated
  ...
  \Appendices{\cref{subsec:applicative-impl}}{Appendix~A.4} as well as
  much of the current attribute-based user interface to control the
  transformation
  (\Appendices{\cref{subsec:user-control}}{Appendix~A.2.2}). Basile
  ...
  (\Appendices{\cref{subsec:PR-history}}{Appendix~A.3}). The work was
